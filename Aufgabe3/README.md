...
* Erstellen und starten Sie in `Main`:
  * 2 Producer-Threads (Writer): Threads, welche jeweils die Methode `TextProducer` starten.  
  * 1 Consumer-Thread (Reader): Thread, welcher die Methode `TextConsumer` startet. 
